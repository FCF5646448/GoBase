...
import (
	...
	instrumenter "github.com/fcf/instrument_trace/instrument"
	"github.com/fcf/instrument_trace/instrument/ast"
)
...
func main() {
	...
	ins = ast.New("github.com/fcf/instrument_trace", "trace", "Trace")
